    ...
    <div class="glass-light rounded-2xl p-6 sm:p-8">
        ...
        <form wire:submit.prevent="updatePassword" class="space-y-5">
            <div>
                ...
                <input type="password" wire:model="current_password" id="current_password" class="input-light w-full rounded-xl px-4 py-2.5 text-sm">
                @error('current_password') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
            </div>

            <div>
                <label for="password" class="block mb-1.5 text-sm font-medium text-gray-700">Password Baru</label>
                <input type="password" wire:model="password" id="password" class="input-light w-full rounded-xl px-4 py-2.5 text-sm">
            ...
            <div>
                ...
                <input type="password" wire:model="password_confirmation" id="password_confirmation" class="input-light w-full rounded-xl px-4 py-2.5 text-sm">
            </div>

            <div class="pt-4 border-t border-gray-100">
                <button type="submit" wire:loading.attr="disabled" class="btn-gradient w-full rounded-xl px-5 py-2.5 text-sm cursor-pointer">
